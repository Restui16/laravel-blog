            ...
            <form action="{{ url('article/'.$article->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="desc" id="myeditor" cols="30" rows="10" class="form-control">{{ old('article', $article->desc) }}</textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mt-2">
                            ...
                            <img src="{{ asset('storage/back/'. $article->img)}}"  class="img-thumbnail img-preview" width="150px">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <select name="status" id="status" class="form-control">
                            ...
                            <option value="0" @if($article->status == 0) selected @endif>Private</option>
                        </select>
                    </div>
...
@push('js')
    ...
    <script>
        var options = {
            ...
            filebrowseBrowseUrl: '/laravel-filemanager?type=Files',
            filebrowseUploadUrl: '/laravel-filemanager/upload?type=File&_token=',
